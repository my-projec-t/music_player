...
const songs= [
    ...
    },
    {
        ...
        poster:"img/ilai/10.jpg"
    },
    {
        id: 11,
        songName: `Kanmani Anbodu Kadhalan
        <br>
        <div class="subtitle"></div>`,
        poster:"img/ilai/11.jpg"
    },
    {
        id: 12,
        songName: `Thenpandi cheemayile
        <br>
        <div class="subtitle"></div>`,
        poster:"img/ilai/12.jpg"
    },
    {
        id: 13,
        songName: `sundari kannal oru sethi 
        <br>
        <div class="subtitle"></div>`,
        poster:"img/ilai/13.jpg"
    },
    {
        id: 14,
        songName: `valai osai
        <br>
        <div class="subtitle"></div>`,
        poster:"img/ilai/14.jpg"
    },
    {
        id: 15,
        songName: `yamunai aatrile
        <br>
        <div class="subtitle"></div>`,
        poster:"img/ilai/15.jpg"
    },
    {
        id: 16,
        songName: `putham pudhu kaalai
        <br>
        <div class="subtitle"></div>`,
        poster:"img/ilai/16.jpg"
    },
    {
        id: 17,
        songName: `Ilamai itho itho
        <br>
        <div class="subtitle"></div>`,
        poster:"img/ilai/17.jpg"
    },
    {
        id: 18,
        songName: `Thai madiyil
        <br>
        <div class="subtitle"></div>`,
        poster:"img/ilai/18.jpg"
    },
    {
        id: 19,
        songName: `Neenga mudiyuma
        <br>
        <div class="subtitle"></div>`,
        poster:"img/ilai/19.jpg"
    },
    {
        id: 20,
        songName: `Unna nenachu
        <br>
        <div class="subtitle"></div>`,
        poster:"img/ilai/20.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((element)=>{
    element.addEventListener('click',(e)=>{
        ...
        music.src = `audio/ilai/${index}.mp3`;
        poster_master_play.src=`img/ilai/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play-fill')
        masterPlay.classList.add('bi-pause-fill')
        download_music.href =`audio/ilai/${index}.mp3`;
